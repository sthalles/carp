...
class CIFAR10Index(datasets.CIFAR10):
    ...
    def __init__(self, *args, **kwargs):
        super(CIFAR10Index, self).__init__(*args, **kwargs)
...
def main():
    ...
    train_dataset  = CIFAR10Index(args.data, train = True, transform = transform, download = True)
    val_dataset  = CIFAR10Index(args.data, train = False, transform = transform, download = True)
